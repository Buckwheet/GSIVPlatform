...
export function buildInvFixture(): Database.Database {
  ...
  db.exec(`
    ...
    CREATE TABLE account (account TEXT NOT NULL PRIMARY KEY, premium_points INTEGER NOT NULL DEFAULT 0, simucoin INTEGER NOT NULL DEFAULT 0, timestamp INTEGER NOT NULL DEFAULT 0);
  `);
